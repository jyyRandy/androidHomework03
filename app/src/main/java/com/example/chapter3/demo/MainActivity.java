...
import com.example.chapter3.demo.fragment_practice.ContainerActivity;
import com.example.chapter3.demo.homework.ThreeBombsActivity;
...
//
        bindActivity(R.id.btn_three_bombs, ThreeBombsActivity.class);
        ...
        bindActivity(R.id.btn_fragment_practice, ContainerActivity.class);
    }
